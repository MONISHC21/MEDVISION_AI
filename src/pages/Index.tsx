...
import { Upload, Cpu, FileText, Rocket, Shield, Zap, Database, ArrowRight, Activity, Brain, ScanLine, CheckCircle2, Sparkles } from "lucide-react";
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden">
      ...
      >
        <nav className="container mx-auto flex items-center justify-between py-4 px-4 md:px-6">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm text-muted-foreground">
            ...
            <a href="#medexplain" className="hover:text-foreground transition-colors">MedExplain</a>
      ...
      {/* MEDEXPLAIN AI — companion AI features */}
      <section id="medexplain" className="py-20 md:py-28 relative">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-2xl mx-auto mb-10">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass text-xs font-medium text-primary mb-4">
              <Sparkles className="w-3.5 h-3.5" /> New · MedExplain AI
            </div>
            <h2 className="text-3xl md:text-5xl font-bold mb-4">
              Understand your <span className="text-gradient">health reports</span>
            </h2>
            <p className="text-muted-foreground text-lg">
              Look up any medical term or chat with our AI health assistant — in your language, at your level.
            </p>
          </div>

          <div className="max-w-5xl mx-auto mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <LanguageToggle language={language} setLanguage={setLanguage} eli10={eli10} setEli10={setEli10} />
            <SafetyDisclaimer compact />
          </div>

          <div className="max-w-5xl mx-auto mb-6">
            <ReportAnalyzer language={language} eli10={eli10} />
          </div>

          <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-6">
            <MedicalTermExplainer language={language} eli10={eli10} />
            <HealthChat language={language} eli10={eli10} />
          </div>



          <p className="text-center text-xs text-muted-foreground mt-8 max-w-2xl mx-auto">
            For full scan analysis (MRI, CT, X-ray, retinal), launch the MedVision AI app.
          </p>
        </div>
      </section>
